...
private:
  ...
  _N *_add(T val, _N *cur) { //O(logn) if balanced otherwise worst case scenerio O(n)
    if (cur) {
...
//----------------------------------------------------------------------------//
  ...
  _N **_find(T val, _N **cur) { //O(logn) if balanced otherwise worst case scenerio O(n)
    if (cur && *cur) {
      T data = (*cur)->data;
...
//----------------------------------------------------------------------------//
  ...
  _N **_findMin(_N **cur) { //O(logn) if balanced otherwise worst case scenerio O(n)
    while ((*cur)->left) cur = &((*cur)->left);
    return cur;
  }
//----------------------------------------------------------------------------//

  _N **_findMax(_N **cur) { //O(logn) if balanced otherwise worst case scenerio O(n)
    while ((*cur)->right) cur = &((*cur)->right);
    return cur;
  }
//----------------------------------------------------------------------------//

  void _deleteNode(_N **cur) { //O(logn) if balanced
